...
application_service = ApplicationService(application_repository, employee_repository, email_service, event_service)
...
async def start_scheduler():
    scheduler.add_job(
        ...
        name="Reject applications older than two months",
