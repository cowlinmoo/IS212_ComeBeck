...
class Employee(EntityMeta):
    ...
    managed_team = relationship("Team", back_populates="manager",
                                foreign_keys="Team.manager_id")
    applications = relationship("Application",
                                foreign_keys="Application.staff_id",
                                back_populates="staff")
    approved_applications = relationship("Application",
                                         foreign_keys="Application.approver_id",
    ...
    directed_department = relationship("Department", back_populates="director",
                                       foreign_keys="Department.director_id")
