from sqlalchemy import Column, BigInteger, String, ForeignKey, DateTime, Date, Enum as SQLAlchemyEnum
...
class Event(EntityMeta):
    ...
    application_hour = Column(SQLAlchemyEnum(ApplicationHourEnum), nullable=False, default = ApplicationHourEnum.FULLDAY)
