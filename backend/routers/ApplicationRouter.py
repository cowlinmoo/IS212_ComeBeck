...
@ApplicationRouter.get("/staff/{staff_id}",
...
@ApplicationRouter.get("/approver/{approver_id}",
                       response_model=List[ApplicationResponse])
...
@ApplicationRouter.put("/withdraw/{application_id}",
...
@ApplicationRouter.put("/withdraw/{application_id}/{event_id}",
...
@ApplicationRouter.get("/status/{status}",
                       response_model=List[ApplicationResponse])
...
@ApplicationRouter.get("/location/{manager_id}",
                       response_model=List[ApprovedApplicationLocationSchema])
def get_all_employee_locations_by_manager_id(
    ...
    return service.get_employee_approved_application_locations(manager_id=manager_id,
                                                               current_user_role=
                                                               current_user["role"])
# @ApplicationRouter.put("/{application_id}/status", response_model=ApplicationResponse)
# def update_application_status(
...
@ApplicationRouter.put("/process/{application_id}",
                       response_model=ApplicationResponse)
