...
INSERT INTO teams (team_id, name, description, created_on, manager_id, department_id, parent_team_id)
VALUES
    (1, 'Engineering', 'Handles product development and software engineering', '2023-01-01 09:00:00', NULL, 1, NULL),
    (2, 'Marketing Team', 'Responsible for branding and communications', '2023-02-15 10:00:00', NULL, 2, NULL),
    (3, 'HR Team', 'Manages employee relations and recruitment', '2023-03-01 11:00:00', NULL, 3, NULL),
    (4, 'Finance Team', 'Oversees financial planning and accounting', '2023-04-01 09:30:00', NULL, 4, NULL),
    (5, 'Support Team', 'Provides assistance and support to customers', '2023-05-01 08:45:00', NULL, 5, NULL),
    (6, 'Frontend Team', 'Develops user interfaces and client-side applications', '2023-06-01 10:00:00', NULL, 1, 1),
    (7, 'Backend Team', 'Develops server-side applications and APIs', '2023-06-02 10:30:00', NULL, 1, 1),
    (8, 'DevOps Team', 'Manages infrastructure and deployment processes', '2023-06-03 11:00:00', NULL, 1, 1),
    (9, 'Digital Marketing', 'Focuses on online marketing strategies', '2023-06-04 09:00:00', NULL, 2, 2),
    (10, 'Content Creation', 'Produces marketing content across various media', '2023-06-05 09:30:00', NULL, 2, 2)
...
VALUES
    (100, 'John', 'Doe', 'CTO', 1, 1, 'Singapore', 'colinmok1000@gmail.com', NULL, 3, '$2b$12$agWjFGi0AaStERzrWIncZe7B7Rc3DaBmSNo7QZ7/wa6HAyxyymMyO'),
    (101, 'Alice', 'Smith', 'Software Engineer', 1, 1, 'USA', 'colinmok3@gmail.com', 100, 1, '$2b$12$agWjFGi0AaStERzrWIncZe7B7Rc3DaBmSNo7QZ7/wa6HAyxyymMyO'),
...
VALUES
    (201, 'WFH Request', 'Requesting to work from home for two weeks due to home renovation.', '2023-07-01 08:00:00', '2023-07-02 10:00:00', 'approved', 101, 100, FALSE, NULL, NULL),
    ...
    (203, 'Flexible Hours', 'Requesting flexible working hours for childcare reasons.', '2023-07-10 14:00:00', '2023-07-11 09:00:00', 'approved', 103, 100, TRUE, 'DAILY', '2023-08-10'),
